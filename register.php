        ...
        <div class="left-sidebar-pro">
		    ...
		    <li align="center"><img src="img/logo/logxx.png" alt="" /></li>
                        <li class="nav-item">
                           ...
                           <li class="nav-item">
                            <a href="login.php"  class="nav-link "><i class=""></i> <span class="btn btn-sm btn-info">Login</span> </a>
                         </li>
                    </ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                                <div class="header-right-info">
                                   ...
                                   <li class="nav-item">
				    <a href=""  class="nav-link"><span class="">Registration</span> </a>
				 </li>
                                    </ul>
                                </div>
                            </div>
				...
				if($validate==true){
					...
					?>
						<script language = "javascript" style = "text/javascript"> 
							window.location = "index.php?user=<?php echo $name?>";	
						</script>
					<?php
				}else{
					//var_dump($validate);
					echo "<script language ='javascript' style = 'text/javascript'>window.location ='register.php?validations=".json_encode($validate)."'</script>";
				}
			}
			?>
			    <div class="row justify-content-center">
